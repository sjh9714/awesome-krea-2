...
<p align="center">Krea 2 Turbo용 재현 가능한 프롬프트 315개, 40개 카테고리. 모든 프롬프트는 복사해서 바로 쓸 수 있고 모든 이미지는 실제 출력물입니다.</p>
